...
import 'package:thirdbank/pages/sendbitcoinpage.dart';
...
class WalletPage extends StatefulWidget {
  ...
  @override
  State<WalletPage> createState() => _WalletPageState(wallet);
}

class _WalletPageState extends State<WalletPage> {
  _WalletPageState(this.wallet);
            ...
            TextButton(
              onPressed: () {
                Clipboard.setData( ClipboardData(
                    text: wallet.transactions[index].txid));
